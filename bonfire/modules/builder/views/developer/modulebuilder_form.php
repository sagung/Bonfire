        ...
        <div class='module-builder'>
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-body">
                    ...
                    if (! $writable) :
                    ?>
                    <div class="alert alert-custom alert-info fade show mb-5" role="alert">
            ...
            ?>
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-body">
                        <fieldset id="module_details">
                            <legend>A. <?php echo lang('mb_form_mod_details'); ?></legend>
                            ...
                            <div class="form-group mb_advanced">
                                ...
                                <div class="checkbox-list" aria-labelledby="contexts_label" role="group">
                            ...
                            <div class="form-group mb_advanced<?php echo form_error('form_action') ? ' error' : ''; ?>">
                                ...
                                <div class="checkbox-list" aria-labelledby="form_action_label" role="group">
                                    <?php
                            ...
                            <div class="form-group" style="display: block;">
                                ...
                                <div class="radio-inline" id='mb_module_db' role="group">
                                    
                                    <label class="inline radio" for="db_no">
                                        <input name="module_db" id="db_no" type="radio" value="" <?php echo set_radio('module_db', '', true); ?> />
                                        <span></span>
                                        <?php echo lang('mb_form_module_db_no'); ?>
                                    </label>
                                
                                    <label class="inline radio" for="db_create">
                                        <input name="module_db" id="db_create" type="radio" value="new" <?php echo set_radio('module_db', 'new'); ?>  />
                                        <span></span>
                                        <?php echo lang('mb_form_module_db_create'); ?>
                                    </label>
                                
                                    <label class="inline radio" for="db_exists">
                                        <input name="module_db" id="db_exists" type="radio" value="existing" <?php echo set_radio('module_db', 'existing'); ?> />
                                        <span></span>
                ...
                <div class="card card-custom gutter-b example example-compact" id="db_details">
                    <div class="card-body">
                        <?php
                        //------------------------------------------------------------------
                        // Table Details
                        ...
                        <fieldset id="table_details">
                            <legend>B. <?php echo lang('mb_form_table_details'); ?></legend>
                            ...
                            <div class="form-group mb_advanced<?php echo form_error('table_name') ? ' error' : ''; ?>">
                                <label for="table_name" class="control-label block"><?php echo lang('mb_form_table_name'); ?></label>
                                    ...
                                    <input class="form-control" name="table_name" id="table_name" type="text" value="<?php echo set_value('table_name'); ?>" placeholder="<?php echo lang('mb_form_table_name_ph'); ?>" />
                            ...
                            <div class="form-group mb_advanced<?php echo form_error('form_error_delimiters') ? ' error' : ''; ?>">
                                <label for="form_error_delimiters" class="control-label block"><?php echo lang('mb_form_err_delims'); ?></label>
                                    ...
                                    <input class="form-control" name="form_error_delimiters" id="form_error_delimiters" type="text" value="<?php echo set_value("form_error_delimiters", "<span class='help-block'>,</span>"); ?>" />
                            ...
                            <div class="form-group mb_advanced">
                                <label for="textarea_editor" class="control-label block"><?php echo lang('mb_form_text_ed'); ?></label>
                                    ...
                                    <select class="form-control" name="textarea_editor" id="textarea_editor">
                            ...
                            <div class="form-group mb_advanced">
                                <div class="checkbox-inline">
                                    <label for="use_pagination" class="checkbox">
                                        ...
                                        <span></span><?php echo lang('mb_form_use_pagination'); ?>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group mb_advanced">
                                <div class="checkbox-inline">
                                    <label for="log_user" class="checkbox">
                                        ...
                                        <span></span><?php echo lang('mb_form_log_user'); ?>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group mb_advanced">
                                <div class="checkbox-inline">
                                    <label for="use_soft_deletes" class="checkbox">
                                        ...
                                        <span></span><?php echo lang('mb_form_soft_deletes'); ?>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group mb_advanced<?php echo form_error('soft_delete_field') ? ' error' : ''; ?>">
                                <label for="soft_delete_field" class="control-label block"><?php echo lang('mb_soft_delete_field'); ?></label>
                                    ...
                                    <input class="form-control" name="soft_delete_field" id="soft_delete_field" type="text" value="<?php echo set_value('soft_delete_field', lang('mb_soft_delete_field_ph')); ?>" />
                            ...
                            <div class="form-group mb_advanced<?php echo form_error('deleted_by_field') ? ' error' : ''; ?>">
                                <label for="deleted_by_field" class="control-label block"><?php echo lang('mb_deleted_by_field'); ?></label>
                                    ...
                                    <input class="form-control" name="deleted_by_field" id="deleted_by_field" type="text" value="<?php echo set_value('deleted_by_field', lang('mb_deleted_by_field_ph')); ?>" />
                                    <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                            ...
                            <div class="form-group mb_advanced<?php echo form_error('created_field') ? ' error' : ''; ?>">
                                <label for="created_field" class="control-label block"><?php echo lang('mb_form_created_field'); ?></label>
                                    ...
                                    <input class="form-control" name="created_field" id="created_field" type="text" value="<?php echo set_value('created_field', lang('mb_form_created_field_ph')); ?>" />
                                    <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                            ...
                            <div class="form-group mb_advanced<?php echo form_error('created_by_field') ? ' error' : ''; ?>">
                                <label for="created_by_field" class="control-label block"><?php echo lang('mb_form_created_by_field'); ?></label>
                                    ...
                                    <input class="form-control" name="created_by_field" id="created_by_field" type="text" value="<?php echo set_value('created_by_field', lang('mb_form_created_by_field_ph')); ?>" />
                                    <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                            ...
                            <div class="form-group mb_advanced">
                                <div class="checkbox-inline">
                                    <label for="use_modified" class="checkbox">
                                        ...
                                        <span></span><?php echo lang('mb_form_use_modified'); ?>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group mb_advanced<?php echo form_error('modified_field') ? ' error' : ''; ?>">
                                <label for="modified_field" class="control-label block"><?php echo lang('mb_form_modified_field'); ?></label>
                                    ...
                                    <input class="form-control" name="modified_field" id="modified_field" type="text" value="<?php echo set_value('modified_field', lang('mb_form_modified_field_ph')); ?>" />
                                    <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                            ...
                            <div class="form-group mb_advanced<?php echo form_error('modified_by_field') ? ' error' : ''; ?>">
                                <label for="modified_by_field" class="control-label block"><?php echo lang('mb_form_modified_by_field'); ?></label>
                                    ...
                                    <input class="form-control" name="modified_by_field" id="modified_by_field" type="text" value="<?php echo set_value('modified_by_field', lang('mb_form_modified_by_field_ph')); ?>" />
                                    <span class="help-inline match-existing-notes"><?php echo lang('mb_form_match_existing'); ?></span>
                            ...
                            //--------------------------------------------------------------
                            ?>
                            <div class="alert alert-custom alert-info fade show mb-5 mb_new_table" role="alert">
                                <div class="alert-text"><?php echo lang('mb_table_note'); ?></div>
                                <div class="alert-close">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true"><i class="ki ki-close"></i></span>
                                    </button>
                ...
                <div class="card card-custom gutter-b example example-compact" id="all_fields">
                    <div class="card-body">
                        <?php
                        //------------------------------------------------------------------
                        // Field Details
                            ...
                            <fieldset id="field<?php echo $count; ?>_details">
                                ...
                                <?php if ($count == 1) : ?>
                                    ...
                                    <div class="alert alert-custom alert-info fade show mb-5" role="alert">
                                        ...
                                        <div class="alert-text"><?php echo lang('mb_field_note'); ?></div>
                                ...
                                <div class="form-group<?php echo form_error($viewFieldName) ? ' error' : ''; ?>">
                                    <label class="control-label" for="<?php echo $viewFieldName; ?>"><?php echo lang('mb_form_fieldname'); ?></label>
                                        ...
                                        <input class="form-control" name="<?php echo $viewFieldName; ?>" id="<?php echo $viewFieldName; ?>" type="text" value="<?php echo set_value($viewFieldName, isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['name'] : ''); ?>" maxlength="30" placeholder="<?php echo lang('mb_form_fieldname_ph'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-inline" aria-labelledby="<?php echo $validationLbl; ?>" role="group">
                                        <?php
                                        ...
                                        <span class="faded">
                                            <label class="inline checkbox" for="<?php echo $validationRulesRuleCount; ?>">
                                                <input class="form-control" name="<?php echo $validationRulesCount; ?>" id="<?php echo $validationRulesRuleCount; ?>" type="checkbox" value="<?php echo $validation_rule; ?>" <?php echo set_checkbox($validationRulesCount, $validation_rule); ?> />
                                                <span></span><?php echo lang("mb_form_{$validation_rule}"); ?>
                                            </label>
                                        </span>
                                        <?php endforeach; ?>
                                ...
                                <div class="form-group mb_advanced">
                                    ...
                                    <div class="radio-inline" aria-labelledby="<?php echo $validLimitLbl; ?>" role="group">
                                        <?php
                                        ...
                                        <span class="faded">
                                            <label class="inline radio" for="<?php echo $validationRulesLimitCount; ?>">
                                                <input class="form-control" name="<?php echo $validationRulesCount; ?>" id="<?php echo $validationRulesLimitCount; ?>" type="radio" value="<?php echo $validation_limit; ?>" <?php echo set_radio($validationRulesCount, $validation_limit); ?> />
                                                <span></span><?php echo lang("mb_form_{$validation_limit}"); ?>
                                            </label>
                                        </span>
                                        <?php endforeach; ?>
                                    </div>
