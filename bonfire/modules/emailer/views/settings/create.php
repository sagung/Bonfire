                ...
                <?php echo form_open($this->uri->uri_string()); ?>
                    <fieldset>
                        <div class='form-group'>
                            ...
                            <input class="form-control input-lg" type="text" size="50" name="email_subject" id="email_subject" value="<?php if (isset($email_subject)) { e($email_subject); } ?>" />
                            
                        </div>
                        <div class='form-group'>
                            <label class='control-label' for='email_content'><?php echo lang('emailer_email_content'); ?></label>
                            <textarea class="form-control" name="email_content" id="email_content" rows="15"><?php
