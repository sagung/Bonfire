		...
		<div class="card">
			<div class="card-header">
                ...
                <ul class="nav nav-tabs nav-bold nav-tabs-line">
                    <li class="active"><a class="nav-link active" href="#app-tab" data-toggle="tab"><?php echo lang('migrations_tab_app'); ?></a></li>
                    <li><a class="nav-link " href="#mod-tab" data-toggle="tab"><?php echo lang('migrations_tab_mod'); ?></a></li>
                    <li><a class="nav-link " href="#core-tab" data-toggle="tab"><?php echo lang('migrations_tab_core'); ?></a></li>
                </ul>
