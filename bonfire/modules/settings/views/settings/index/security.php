    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
        ...
        <fieldset>
            ...
            <div class="form-group<?php echo form_error('allow_register') ? $errorClass : ''; ?>">
                <div class="checkbox-inline">
                    <label class='checkbox' for="allow_register">
                        ...
                        <span></span><?php echo lang('bf_allow_register'); ?>
                    </label>
            ...
            <div class="form-group">
                ...
                <div class="radio-inline" aria-labelledby="use_usernames_label" role="group">
            ...
            <div class="form-group">
                ...
                <div class="checkbox-inline" aria-labelledby='allow_name_change_label' role='group'>
            ...
            <div class="form-group">
                <div class="checkbox-inline">
                    <label class="checkbox" for="allow_remember">
                        ...
                        <span></span><?php echo lang('bf_allow_remember'); ?>
                    </label>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="checkbox-list" aria-labelledby='password_options_label' role='group'>
                    <label class="checkbox" for="password_force_numbers">
                        ...
                        <span></span><?php echo lang('bf_password_force_numbers'); ?>
                    </label>
                    <label class="checkbox" for="password_force_symbols">
                        ...
                        <span></span><?php echo lang('bf_password_force_symbols'); ?>
                    </label>
                    <label class="checkbox" for="password_force_mixed_case">
                        ...
                        <span></span><?php echo lang('bf_password_force_mixed_case'); ?>
                    </label>
                    <label class="checkbox" for="password_show_labels">
                        ...
                        <span></span><?php echo lang('bf_password_show_labels'); ?>
                    </label>
                </div>
            </div>
