...
<html lang="en">
	...
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url(<?php echo base_url(); ?>assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-static subheader-enabled page-loading">	
        <!--begin::Main-->
        <!--begin::Header Mobile-->
