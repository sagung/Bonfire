...
<html lang="en">
	...
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url(<?php echo Template::theme_url(); ?>assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-static subheader-enabled page-loading">	
        <!--begin::Main-->
        <!--begin::Header Mobile-->
		<div id="kt_header_mobile" class="header-mobile">
            ...
            <!--begin::Logo-->
            <a href="index.html">
                <img alt="Logo" src="<?php echo Template::theme_url(); ?>assets/media/logos/logo-letter-1.png" class="logo-default max-h-30px" />
            </a>
            <!--end::Logo-->
