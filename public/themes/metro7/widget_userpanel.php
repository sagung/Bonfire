...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
            ...
            <div class="offcanvas-content pr-5 mr-n5">
                ...
                <div class="d-flex align-items-center mt-5">
                    <div class="symbol symbol-100 mr-5">
                        <div class="symbol-label" >
                            <?php echo gravatar_link($current_user->email, 96, null, $userDisplayName,'user-image'); ?>
                        </div>
                        <i class="symbol-badge bg-success"></i>
                    </div>
                    <div class="d-flex flex-column">
                        <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">
                            <?php e($userDisplayName); ?>
                        </a>
                        <div class="text-muted mt-1">
                            <?php e($current_user->role_name); ?>
                        </div>
                        <div class="navi mt-2">
                ...
                <div class="navi navi-spacer-x-0 p-0">
                    <!--begin::Item-->
                    <a href="<?php echo site_url(SITE_AREA . '/settings/users/edit'); ?>" class="navi-item">
                        <div class="navi-link">
                    ...
                    <!--begin::Item-->
                    <a href="<?php echo site_url(SITE_AREA . '/reports/activities'); ?>"  class="navi-item">
                        <div class="navi-link">
                            <div class="symbol symbol-40 bg-light mr-3">
                                <div class="symbol-label">
